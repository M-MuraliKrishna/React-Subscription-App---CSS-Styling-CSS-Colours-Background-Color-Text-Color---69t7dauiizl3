      ...
      <section class="card-section">
        <div class="container">
          <div class="community">
            ...
            <h3 class="community-sub-header">30-day, hassle-free monkey back gurarantee</h3>
            <p class="community-text">Gain access to our full library of tutorials along with expert
              code reviews. Perfect for any developers who are serious about honing their skills. </p>
          </div>
